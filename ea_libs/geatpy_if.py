...
from ea_libs.algorithm.soea_DE_best_1_L_templet import soea_DE_best_1_L_templet
...
class EALibInterface(object):
  ...
  def ea_algorithm_factory(self, algorithm_name):
    return {
        "soea_DE_best_1_L_templet": soea_DE_best_1_L_templet
    }[algorithm_name]
  ...
  def solve(self, env, args):
    ...
    msglogger.info("\tValid evolution generations: %s" % obj_trace.shape[0])
